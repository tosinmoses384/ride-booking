  ...
  const driverLists2 = [
    {
      ...
      driving_license: "D1234567890123",
      vehicle_color: "Black",
      rate: "2.50",
      ratings: 4.7,
      totalEarning: 5000,
      ...
      cancelRides: 2,
      status: "active",
      createdAt: new Date("2020-01-10T12:00:00Z"),
      updatedAt: new Date("2025-01-30T12:00:00Z"),
    },
    {
      id: "d12345",
      name: "John Doe",
            ...
            <>
              ...
              >
                ...
                <View style={{ padding: windowWidth(10) }}>
                  {driverLists2?.map((driver: DriverType) => (
                    <Pressable
                      style={{
